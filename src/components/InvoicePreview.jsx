...
//     setDownloading(true);
//     const safeFilename = `Proforma_${invoice.invoiceNumber.replace(/\//g, '_')}.pdf`;
...
//             className="flex items-center gap-2 px-4 py-2 hover:cursor-pointer border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 text-sm font-semibold transition-colors"
//           >
...
//             className="flex items-center gap-2 px-5 py-2 hover:cursor-pointer bg-indigo-650 hover:bg-indigo-750 disabled:bg-indigo-400 text-white rounded-xl text-sm font-semibold shadow-sm transition-colors"
//           >
...
//               <div>
//                 <div className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">BILL TO</div>
...
//                 <span className="col-span-5 font-bold text-slate-800">Proforma No:</span>
//                 <span className="col-span-7 font-mono text-slate-900 font-extrabold tracking-wide">{invoice.invoiceNumber}</span>
//               </div>

//               <div className="grid grid-cols-12 gap-1 items-center pt-2">
//                 <span className="col-span-5 font-bold text-slate-800">Date:</span>
//                 <span className="col-span-7 font-mono text-slate-700">{formatDateString(invoice.invoiceDate)}</span>
//               </div>

//               <div className="grid grid-cols-12 gap-1 items-center">
//                 <span className="col-span-5 font-bold text-slate-800">Due Date:</span>
//                 <span className="col-span-7 font-mono text-slate-700">{formatDateString(invoice.dueDate)}</span>
//               </div>
...
//                     <span className="font-semibold text-slate-655">GSTIN:</span>
//                     <span className="font-mono text-slate-800">{invoice.company.gstin}</span>
//                   </div>
//                 )}
//                 {invoice.company.pan && (
//                   <div className="flex justify-between">
//                     <span className="font-semibold text-slate-655">PAN:</span>
//                     <span className="font-mono text-slate-800">{invoice.company.pan}</span>
//                   </div>
//                 )}
//               </div>
//             </div>
...
//               <div className="col-span-2 py-2.5 px-2 border-r border-slate-800">Time Frame (Months)</div>
...
//                     <div className="col-span-7 py-3 px-3 border-r border-slate-900 flex items-center bg-white text-left whitespace-pre-line font-medium text-slate-900">
//                       <div>
//                         <span className="font-bold text-slate-400 mr-1.5">{index + 1}.</span>
//                         {item.description}
//                       </div>
//                     </div>

//                     {/* Quantity / timeframe col */}
//                     <div className="col-span-2 py-3 px-2 border-r border-slate-900 flex items-center justify-center font-mono text-center">
//                       {item.timeFrame}
//                     </div>
...
//               <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest border-b border-slate-100 pb-1 mb-1">
...
//                   <span className="col-span-7 font-bold text-slate-705">Sub Total</span>
//                   <span className="col-span-5 text-right font-mono font-semibold text-slate-900">
//                     {formatIndianCurrency(invoice.subtotal)}
//                   </span>
//                 </div>

//                 <div className="grid grid-cols-12 py-2 px-3">
//                   <span className="col-span-7 font-bold text-slate-705">CGST (9%)</span>
...
//                 <div className="grid grid-cols-12 py-2 px-3">
//                   <span className="col-span-7 font-bold text-slate-705">SGST (9%)</span>
//                   <span className="col-span-5 text-right font-mono font-semibold text-slate-800">
...
//                   <span className="col-span-5 text-right font-mono text-indigo-700">
...
//               <ol className="list-decimal pl-4 space-y-1 text-slate-700 leading-relaxed">
...
//               <span className="block italic leading-tight text-slate-600 font-medium">{invoice.company.address}</span>
//             </div>
...
//                 <span className="font-mono font-medium text-slate-700">{invoice.company.phone}</span>
//               </div>
//               <div className="flex items-center gap-1.5">
//                 <Mail className="w-3 h-3 text-amber-500 shrink-0" />
//                 <span className="font-medium text-slate-700 truncate">{invoice.company.email}</span>
//               </div>
//               <div className="flex items-center gap-1.5 font-medium">
//                 <Globe className="w-3 h-3 text-indigo-500 shrink-0" />
//                 <span className="text-slate-705 truncate">{invoice.company.website}</span>
//               </div>
//             </div>
...
//   // const printableAreaId = `printable-proforma-invoice-${invoice.id}`;
//   const printableAreaId = `printable-proforma-invoice-${invoice.id || 'preview'}`;
...
//               <div className="divide-y divide-slate-900 flex-1">
//                 <div className="grid grid-cols-12 py-2 px-3">
//                   <span className="col-span-7 font-extrabold text-slate-705">Sub Total</span>
...
//                 <div className="grid grid-cols-12 py-2 px-3">
//                   <span className="col-span-7 font-semibold text-slate-705">CGST (9%)</span>
//                   <span className="col-span-5 text-right font-mono font-semibold text-slate-800">
//                     {formatIndianCurrency(invoice.cgst)}
//                   </span>
//                 </div>
...
//                 <div className="grid grid-cols-12 py-2 px-3">
//                   <span className="col-span-7 font-semibold text-slate-705">SGST (9%)</span>
//                   <span className="col-span-5 text-right font-mono font-semibold text-slate-800">
//                     {formatIndianCurrency(invoice.sgst)}
//                   </span>
//                 </div>
